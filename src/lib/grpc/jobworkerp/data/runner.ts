 ...
 * to avoid repeated Protobuf → JSON Schema conversions
 */
...
export const MethodProtoMap: MessageFns<MethodProtoMap> = {
  encode(message: MethodProtoMap, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    globalThis.Object.entries(message.schemas).forEach(([key, value]: [string, MethodSchema]) => {
  ...
  fromPartial(object: DeepPartial<MethodProtoMap>): MethodProtoMap {
    const message = createBaseMethodProtoMap();
    message.schemas = (globalThis.Object.entries(object.schemas ?? {}) as [string, MethodSchema][]).reduce(
      (acc: { [key: string]: MethodSchema }, [key, value]: [string, MethodSchema]) => {
        if (value !== undefined) {
...
export const MethodJsonSchemaMap: MessageFns<MethodJsonSchemaMap> = {
  encode(message: MethodJsonSchemaMap, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    globalThis.Object.entries(message.schemas).forEach(([key, value]: [string, MethodJsonSchema]) => {
  ...
  fromPartial(object: DeepPartial<MethodJsonSchemaMap>): MethodJsonSchemaMap {
    const message = createBaseMethodJsonSchemaMap();
    message.schemas = (globalThis.Object.entries(object.schemas ?? {}) as [string, MethodJsonSchema][]).reduce(
      (acc: { [key: string]: MethodJsonSchema }, [key, value]: [string, MethodJsonSchema]) => {
        if (value !== undefined) {
